...
class _ButtonsTabBarState extends State<ButtonsTabBar> with TickerProviderStateMixin {
  ...
  Widget _buildButton(
    ...
    return Padding(
      ...
      child: TextButton(
        onPressed: () {
          if (widget.prohibits.contains(index)) {
            return;
          }
          print("widget.prohibits!.contains(index)" + widget.prohibits!.contains(index).toString());
        ...
        style: ButtonStyle(
            ...
            overlayColor: MaterialStateProperty.all(AppThemes.tabBgColor)),
        child: Ink(
        ...
        builder: (context, child) => SizedBox(
          ...
          child: widget.isShowScrollBar
              ? RawScrollbar(
                  ...
                  // 滚动条圆角
                  thumbColor: ThemeService().theme.colorScheme.tertiary,
                  controller: _scrollController,
                  scrollbarOrientation: ScrollbarOrientation.top,
                  padding:
                      EdgeInsets.only(top: widget.preferredSize.height - 5, left: 10, right: 10),
    ...
    return SingleChildScrollView(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(AppValues.radius_12 * 6), // 设置圆角的半径
        ),
        child: Row(
  ...
  _scrollTo(int index) {
    ...
    offset *= (_textLTR ? 1 : -1);
    if (widget.onTap != null) {if(_currentIndex!=index){
      widget.onTap!(index);
    }}
