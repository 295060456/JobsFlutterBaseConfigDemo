...
class CustomButton extends StatelessWidget {
  ...
  /// 按钮的文字颜色 优先级：
  /// [textStyle.fontColor] > [textColor] > [colorScheme.primary]
  ...
  Text _buildTitle(ButtonThemeData themeData,TextTheme textTheme) {
    ...
    return Text(title!,
        ...
        maxLines: 1,
        style: textStyle ?? textTheme.bodyMedium?.copyWith(color: textColor,fontWeight: fontWeight));
  }
