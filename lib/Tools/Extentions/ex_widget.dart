...
import '../Others/theme_service.dart';
...
extension ExWidget on Widget {
  ...
  Widget border({
    ...
    BoxDecoration decoration = BoxDecoration(
      ...
      borderRadius: all == null ? null : BorderRadius.only(
        topLeft: Radius.circular(radiusTopLeft ?? radiusAll ?? 0.0),
        topRight: Radius.circular(radiusTopRight ?? radiusAll ?? 0.0),
        bottomLeft: Radius.circular(radiusBottomLeft ?? radiusAll ?? 0.0),
        bottomRight: Radius.circular(radiusBottomRight ?? radiusAll ?? 0.0),
    ),
    ...
    double? blurRadius,
      ...
      Container(
        decoration: BoxDecoration(
          color: color ?? ThemeService().theme.colorScheme.surfaceVariant,
          ...
          boxShadow: [
            BoxShadow(
              ...
              color: shadowColor ?? AppThemes.colorShadow.withOpacity(0.15),
              // 阴影模糊半径
