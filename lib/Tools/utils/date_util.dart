...
class DateFormats {
  ...
  static String full_en = 'dd-MM-yyyy HH:mm:ss';
...
class DateUtil {
  ...
  static String getWeekday(DateTime? dateTime,
    ...
    switch (dateTime.weekday) {
      case 1:
        weekday = S.current.random_text_868;
        break;
      case 2:
        weekday = S.current.random_text_869;
        break;
      case 3:
        weekday = S.current.random_text_870;
        break;
      case 4:
        weekday = S.current.random_text_871;
        break;
      case 5:
        weekday = S.current.random_text_872;
        break;
      case 6:
        weekday = S.current.random_text_873;
        break;
      case 7:
        weekday = S.current.random_text_874;
        break;
      default:
        break;
    }
  ...
  ///一个小时
  static bool isWithinOneHour(int? milliseconds, {bool isUtc = false, int? locMs}) {
    if (milliseconds == null || milliseconds == 0) return false;
    DateTime matchTime =
    DateTime.fromMillisecondsSinceEpoch(milliseconds, isUtc: isUtc);
    DateTime now;
    ...
    // 判断比赛时间是否在提前的now和当前now之间
    return matchTime.isAfter(oneHourAgo) && matchTime.isBefore(now);
  }
