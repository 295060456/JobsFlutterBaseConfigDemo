...
class _CopyToClipboardWidgetState extends State<CopyToClipboardWidget> {
  ...
  OverlayEntry _createOverlayEntry(BuildContext context, Offset offset, ArrowDirection direction) {
    return OverlayEntry(
  ...
  void _copyToClipboard(BuildContext context, GlobalKey key, ArrowDirection direction) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            key: buttonKey1,
            onPressed: () => _copyToClipboard(context, buttonKey1, ArrowDirection.down),
            child: const Text('复制 (箭头向下)'),
          ),
          const SizedBox(height: 10),
          ElevatedButton(
            key: buttonKey2,
            onPressed: () => _copyToClipboard(context, buttonKey2, ArrowDirection.up),
