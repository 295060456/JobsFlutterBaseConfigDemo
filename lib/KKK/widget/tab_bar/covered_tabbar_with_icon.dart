...
///tab数量较少时为平均分配
class CoveredTabBarWithIcon extends StatefulWidget implements PreferredSizeWidget {
  CoveredTabBarWithIcon({
    Key? key,
    required this.tabs,
    this.controller,
    this.duration = 250,
...
class _ButtonsTabBarState extends State<CoveredTabBarWithIcon> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CoveredTabBarWithIcon oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    var wid = MediaQuery.of(context).size.width - (32*2) ;
    //误删
    // log("wid ${wid}");
