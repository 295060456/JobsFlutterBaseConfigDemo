...
class CustomIconButton extends StatefulWidget {
  ...
  final ScalingText? animationWidget;
...
class _CustomIconButtonState extends State<CustomIconButton> {
    ...
    if (widget.direction == Direction.bottom) {
      ctn = SizedBox(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildText(defaultTextTheme, EdgeInsets.only(top: widget.padding)),
            ],
          ));
      ...
      ctn = SizedBox(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              _buildText(defaultTextTheme, EdgeInsets.only(left: widget.padding)),
            ],
          ));
      ...
      ctn = SizedBox(
          ...
          child: Row(
            ...
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
              _buildText(defaultTextTheme, EdgeInsets.only(right: widget.padding)),
              // 图片
              SizedBox(
      ...
      ctn = SizedBox(
          ...
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
              _buildText(defaultTextTheme, EdgeInsets.only(bottom: widget.padding)),
              // 图片
              SizedBox(
                height: widget.iconHeight,
                width: widget.iconWidth,
  ...
  _buildText(TextTheme textTheme, EdgeInsetsGeometry padding) {
    return widget.animationWidget != null
        ? Padding(
            padding: padding,
