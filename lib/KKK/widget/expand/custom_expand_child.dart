...
import 'custom_expand_indicator.dart';
...
/// 自定义扩张的，上下伸缩
class CustomExpandChild extends StatefulWidget {
  ...
  /// Method to override the [CustomExpandIndicator] widget for expanding the content.
  ...
  @override
  State<StatefulWidget> createState() => _CustomExpandChildState();
}

class _CustomExpandChildState extends State<CustomExpandChild>
